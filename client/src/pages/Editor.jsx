...
import { Code2, Cross, MessageCircle, MessagesSquare, Monitor, Rocket, Send, X } from 'lucide-react'
...
function WebsiteEditor() {
  ...
  "🎨 Designing layout and UI...",
  "🧩 Building components...",
  "⚙️ Generating HTML and CSS...",
  "✨ Polishing styles and responsiveness...",
...
bg-white/5 border border-white/5 text-zinc-400 italic'>{thinkingSteps[thinkingIndex]}</div>
   ...
   <div className='p-3 border-t border-white/10'>
      <div className='flex gap-2'>
        ...
        className='flex-1 resize-none rounded-2xl px-4 py-3 bg-white/5 
       border border-white/10 text-sm outline-none '/>
        <button
        onClick={handleUpdate}
        disabled={updateLoading}
         className='px-4 py-3 rounded-2xl bg-white text-black'><Send size={14}/></button>
      </div>
       ...
       <div className='flex-1 flex flex-col '>
         ...
         to-purple-500 text-sm font-semibold hover:scale-105 transition' ><Rocket size={14}/>Deploy</button>
          ...
          onClick={()=>setShowFullPreview(true)}
           className='p-2'><Monitor size={18}/></button>
        </div>
          ...
          >
            ...
            onClick={()=>setShowFullPreview(false)}
             className='absolute top-4 right-4 p-2
              bg-black/70 rounded-lg'><X/></button>
